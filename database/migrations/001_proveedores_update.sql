...
-- Volcando datos para la tabla keeper.cliente: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla keeper.empresa: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla keeper.sessions: ~2 rows (aproximadamente)
...
INSERT INTO `usuario` (`id`, `username`, `email`, `password_hash`, `nombre_completo`, `rol`, `estado`, `ultimo_acceso`, `telefono`, `ci`, `departamento`, `created_at`, `updated_at`) VALUES
	...
	(3, 'admin2', 'admin2@example.com', '$2b$10$1XI8jPOTXJhbsv4BpBF6ae7KG07y0gvKvsXmoKGEGk8xRopLEn/.C', NULL, 'ADMIN', 'ACTIVO', '2025-09-26 19:50:27', NULL, NULL, NULL, '2025-09-26 16:00:13', '2025-09-26 19:50:27');
