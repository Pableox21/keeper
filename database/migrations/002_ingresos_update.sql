...
-- Volcando datos para la tabla keeper.almacen: ~2 rows (aproximadamente)
INSERT INTO `almacen` (`id`, `codigo`, `nombre`, `direccion`, `telefono`, `observacion`, `zona`, `estado`, `es_principal`, `es_tecnico`, `capacidad`, `id_cuenta_contable`, `id_tipo`, `id_responsable`, `id_centro_costo`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES
	(1, 'ALM-PRINCIPAL', 'ALMACEN CENTRAL', 'Casa Matriz - Zona Centra SACABAl', '4444444', 'Almacén principal de la empresa oP', 'CENTRAL', 'ACTIVO', 1, 0, 5000, 1, 1, 3, NULL, '2025-09-30 18:40:48', '2025-10-01 12:44:39', 3, NULL),
	(2, 'ALM-TEC-01', 'ALMACEN TECNICO ZONA SUR - ACTUALIZADO', 'Zona Sur, Av. Principal #123', '5555555', 'Almacén para técnicos de la zona sur - Capacidad aumentada', 'SUR', 'INACTIVO', 0, 1, 1500, 1, 3, 3, NULL, '2025-09-30 18:50:07', '2025-09-30 19:08:10', 3, 3);
...
-- Volcando datos para la tabla keeper.ingreso: ~1 rows (aproximadamente)
...
INSERT INTO `inventario` (`id`, `id_producto`, `id_almacen`, `stock_actual`, `costo_promedio`, `updated_at`) VALUES
	(2, 1, 1, 15, 500.00, '2025-09-30 20:25:48');
...
-- Volcando datos para la tabla keeper.sessions: ~4 rows (aproximadamente)
