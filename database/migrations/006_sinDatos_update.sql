...
CREATE TABLE IF NOT EXISTS `producto` (
  ...
  `requiere_conversion_tecnico` tinyint(1) NOT NULL DEFAULT 0,
  `unidad_tecnico_id` int(11) DEFAULT NULL,
  `factor_conversion_tecnico` decimal(10,3) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `created_by` int(11) DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL,
  ...
  CONSTRAINT `fk_producto_unidad_tecnico` FOREIGN KEY (`unidad_tecnico_id`) REFERENCES `unidad_medida` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
